...
- wind_mitigation_credit (true / false / null — does the dec page show ANY wind/windstorm mitigation credit or discount (e.g. "Wind Mitigation Credit", "Windstorm Mitigation", "Wind Loss Mitigation", opening-protection / roof-deck / roof-cover credits)? true if any such credit is shown, false if the policy clearly shows none, null if you cannot tell)
