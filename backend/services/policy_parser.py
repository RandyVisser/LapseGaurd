...
- listed_parties (array of objects — coverage parties listed on the dec page other than the named insured; DO NOT include the insurance agent, agency, producer, or broker — only include parties who receive coverage or have a financial interest in the property; for each entry include: "name" (string) and "designation" (string — copy the EXACT label printed on the document next to or above their name, e.g. "Additional Insured", "Additional Interest", "Mortgagee", "Loss Payee", "Certificate Holder", "ATIMA"); empty array if none)
...
- dwelling_coverage (number in dollars or null — Coverage A / Dwelling / Building Property limit)
- coverage_c (number in dollars or null — Coverage C / Personal Property / Contents limit)
- liability_coverage (number in dollars or null)
- deductible (number in dollars or null)
- premium (number in dollars or null — the TOTAL policy premium for the policy term; look for "Total Premium", "Policy Premium", "Annual Premium", "Total Cost"; use the full premium, not an installment or fee)
- wind_mitigation_credit (true / false / null — does the dec page show ANY wind/windstorm/hurricane mitigation credit, discount, or protective-device line item? Look for wording such as "Wind Mitigation Credit", "Windstorm Mitigation", "Wind Loss Mitigation", "Windstorm Protective Devices", "Wind/Hurricane Protective Devices", "Protective Devices", "Hurricane Protection", or opening-protection / roof-deck / roof-cover / terrain credits. A line item like "Windstorm Protective Devices ($1,255.00)" IS a wind mitigation credit → return true. true if ANY such credit/line item appears (even with a dollar amount), false ONLY if the policy clearly shows none, null if you cannot tell)
- water_damage_exclusion (true / false / null — is there a water-damage EXCLUSION or a limited/capped water-damage endorsement (e.g. "Water Damage Exclusion", "Limited Water Damage Coverage", "Water Damage Limitation")? true if present, false if not present, null if you cannot tell)
