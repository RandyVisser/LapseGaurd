...
// Hidden entirely until VITE_BILLING_ENABLED=true, and silent while the trial
// has more than 14 days left or once the association has a subscription.
...
export default function TrialBanner({ hoaId }) {
  ...
  if (data.trial_days_left > 14) return null
