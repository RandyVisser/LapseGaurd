      ...
      <section className="hero">
        <div className="wrap">
          <div>
            ...
            <p className="lede">Track every owner’s HO-6 insurance in one dashboard. Each HO-6 Declaration page is reviewed automatically, compliance is verified, and renewal reminders are sent before policies expire. One expired HO-6 policy can expose your entire association. <strong>condo.insure</strong> makes sure you know before it becomes a problem.</p>
